...
def main():
    ...
    path = "real_time"
    packet_limit = np.inf
    FM_grace = 300  # Packet number of Feature Mapping grace period (training phase 1)
    AD_grace = 3200  # Packet number of Anomaly Detection grace period (training phase 2)
